    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Perpustakita</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="?page=anggota"><i class="fa fa-solid fa-users fa-3x"></i> Data Anggota</a>
                    </li>


                    <li>
                        <a  href="?page=buku"><i class="fa fa-solid fa-book fa-3x"></i> Data Buku</a>
                    </li>

                    <li>
                        <a  href="?page=data buku"><i class="fa fa-solid fa-book fa-3x"></i> Data Buku</a>
                    </li>

                    <li>
                        <a  href="?page=transaksi"><i class="fa fa-money fa-3x"></i> Peminjaman</a>
                    </li>
